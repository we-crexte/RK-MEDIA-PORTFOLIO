...
export function Testimonials() {
  return (
    <section className="pt-10 pb-24 px-10 bg-black/40 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold uppercase text-center mb-20 tracking-tighter">Voice of Creators</h2>
